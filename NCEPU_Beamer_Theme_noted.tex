...
\begin{frame}
	\titlepage
	\note{各位老师好，我是来自智能实验1901的林新辉。我的毕业设计题目是基于数据驱动的动力电池剩余寿命预测方法研究，以下我将向各位老师汇报毕业设计的基本情况。}
\end{frame}

% 目录页
\begin{frame}{\small 目录}
	\tableofcontents[sectionstyle=show,subsectionstyle=show/shaded/hide,subsubsectionstyle=show/shaded/hide]
    \note{首先，我将简要介绍本课题的研究背景和研究对象，进而介绍使用的方法和实验结果，最后总结课题内容，介绍下一步工作。}
\end{frame}
